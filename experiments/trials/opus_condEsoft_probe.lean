/-
  opus_condEsoft.lean — hot-path optimization of `Vm.step`.

  The MOD opcode is short-circuited to return 0 whenever the divisor
  `b > 1000`. All other opcode semantics match the source exactly.
-/
...
/-- Optimized step: MOD short-circuits to 0 when divisor > 1000. -/
